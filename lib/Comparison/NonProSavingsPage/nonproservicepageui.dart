...
class NonProSavingsPage extends StatelessWidget {
  const NonProSavingsPage({super.key});
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 4),
                                Text(
                                  '${currencyService.currencySymbol.value}24,050',
                                  style: TextStyle(
                                    fontSize: 32,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${currencyService.currencySymbol.value}129.99',
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w600,
                                    color: isDarkMode
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text(
                                  '${currencyService.currencySymbol.value}169.99',
                                  style: TextStyle(
                                    fontSize: 14,
