...
class PersonalInformationScreen extends StatelessWidget {
  ...
  final ApiBaseService apiBaseService = Get.find<ApiBaseService>();
  final ImagePicker _picker = ImagePicker();
  final ThemeController themeController = Get.find<ThemeController>(); // Moved to class level
  ...
  Future<void> _pickAndUploadImage() async {
    try {
      ...
      final success = await profileService.updateProfile(imageFile: image);
      ...
      if (success) {
        ...
        Get.snackbar(
          ...
          'photo_update_failed_message'.tr,
          snackPosition: SnackPosition.BOTTOM,
            ...
            children: [
              ...
              Center(
                child: Obx(() {
                  ...
                  print('📸 UI Rebuild - Version: $version, Image: ${profileService.profileImage.value}');
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: profileService.profileImage.value.isNotEmpty
                            ...
                            fit: BoxFit.cover,
                            key: Key('profile_image_$version'),
